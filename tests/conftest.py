...
# WARNING: Ensure imports from `freegpt3.5docs` comes after this line
from freegpt3.5docs import app, settings, db  # noqa
from freegpt3.5docs.cli import create_user, cli  # noqa
