...
- 🎯 Entry points to execute your program using `python -m <freegpt3.5docs>` or `$ freegpt3.5docs` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/jaypaunrender/FreeGpt3.5Docs/branch/main/graph/badge.svg?token=FreeGpt3.5Docs_token_here)](https://codecov.io/gh/jaypaunrender/FreeGpt3.5Docs)
[![CI](https://github.com/jaypaunrender/FreeGpt3.5Docs/actions/workflows/main.yml/badge.svg)](https://github.com/jaypaunrender/FreeGpt3.5Docs/actions/workflows/main.yml)

Awesome freegpt3.5docs created by jaypaunrender

## Install

from source
```bash
git clone https://github.com/jaypaunrender/FreeGpt3.5Docs freegpt3.5docs
cd freegpt3.5docs
make install
```
...
```bash
pip install freegpt3.5docs
```

## Executing

```bash
$ freegpt3.5docs run --port 8080
```

or

```bash
python -m freegpt3.5docs run --port 8080
```

or

```bash
$ uvicorn freegpt3.5docs:app
```
...
```bash
❯ freegpt3.5docs --help
Usage: freegpt3.5docs [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ freegpt3.5docs create-user --help
Usage: freegpt3.5docs create-user [OPTIONS] USERNAME PASSWORD
...
```bash
freegpt3.5docs create-user admin admin --superuser
```
...
Run with `freegpt3.5docs run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `freegpt3.5docs create-user`.
...
-----------------------------------------------------
freegpt3.5docs/__init__.py              4      0   100%
freegpt3.5docs/app.py                  16      1    94%
freegpt3.5docs/cli.py                  21      0   100%
freegpt3.5docs/config.py                5      0   100%
freegpt3.5docs/db.py                   10      0   100%
freegpt3.5docs/models/__init__.py       0      0   100%
freegpt3.5docs/models/content.py       47      1    98%
freegpt3.5docs/routes/__init__.py      11      0   100%
freegpt3.5docs/routes/content.py       52     25    52%
freegpt3.5docs/routes/security.py      15      1    93%
freegpt3.5docs/routes/user.py          52     26    50%
freegpt3.5docs/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in freegpt3.5docs/default.toml.
